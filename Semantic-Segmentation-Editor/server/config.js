...
const init = ()=> {
    try {
        ...
        if (!existsSync(configurationFile.imagesFolder)){
            ...
            download("https://raw.githubusercontent.com/eklowlabs/Semantic-Segmentation-Editor/docs/resource/private/samples/bitmap_labeling.jpg", configurationFile.imagesFolder);
            download("https://raw.githubusercontent.com/eklowlabs/Semantic-Segmentation-Editor/docs/resource/private/samples/pointcloud_labeling.pcd", configurationFile.imagesFolder);
        }
